...
CREATE TABLE group_task (status VARCHAR(255) NOT NULL,due_date DATE NOT NULL,task_id INT NOT NULL,user_id INT NOT NULL,group_id INT NOT NULL,FOREIGN KEY (task_id) REFERENCES task(id),FOREIGN KEY (user_id) REFERENCES user(id),FOREIGN KEY (group_id) REFERENCES `group`(group_id));
-- Inserting users
...
-- Inserting groups
INSERT INTO `group` (name) VALUES ('Group 1'),('Group 2'),('Team Alpha');
-- Inserting tasks
